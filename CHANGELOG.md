...
- 新增磁力菇 🧲（magnetshroom）：自身不攻击，持续把场上所有僵尸（含游荡者）
  纵向吸到自己所在的这一行，把整片草坪的进攻压缩成一条线
- 磁力菇 🧲 + 绿叶素：0.5 秒把全场僵尸吸成一条直线，然后引爆磁场 ——
  先扒掉路障 / 铁桶 / 铁门 / 报纸等金属护甲，再对每个僵尸造成 17000 点伤害
  （正好是本作僵尸满血），游荡者被轰回右侧重新爬
- 磁力菇外观：紫色脉动光晕，被吸僵尸带紫色描边，大招目标行整条亮起磁场与冲击波
